    ...
    <header className="bg-white shadow-sm py-4">
      <div className="container mx-auto flex justify-between items-center px-4">
        <div className="flex items-center">
          <Icon name="Leaf" className="h-8 w-8 text-green-600 mr-2" />
        ...
        <nav className="hidden md:flex gap-6">
          ...
          <a href="#cottages" className="text-gray-700 hover:text-green-600">Коттеджи</a>
          <a href="#bathhouse" className="text-gray-700 hover:text-green-600">Банный комплекс</a>
